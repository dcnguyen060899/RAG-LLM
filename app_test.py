...
from transformers import AutoTokenizer, AutoModelForCausalLM, TextStreamer, GPT2Tokenizer, GPT2Model, GPT2LMHeadModel
...
llm = HuggingFaceLLM(
    context_window=1024,
    max_new_tokens=254,
    temperature=0.7,    # Adjust for randomness, can be between 0.5 and 1.0
